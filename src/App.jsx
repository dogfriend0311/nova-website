...
import { getSess, saveSess, clearSess, useIsMobile, CSS, sb, gid } from "./shared";
...
import StatsPage, { HubPage } from "./pages/StatsPage";
import NewsPage from "./pages/NewsPage";
import { GameDetailPage } from "./pages/GameDetailPage";
import CardsPage from "./pages/CardsPage";
import GMModePage from "./pages/GMModePage";
import { NFFLPage, NBBLPage, RingRushPage } from "./pages/LeaguePage";
import DashboardPage from "./pages/DashboardPage";
import MatchupPage from "./pages/MatchupPage";
import AnimeCardGame from "./pages/AnimeCardGame";
...
export default function App(){
  ...
  const content=()=>{
    ...
    if(page==="gmmode")return <GMModePage cu={cu}/>;
