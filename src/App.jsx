...
import RTTSMode from './components/RTTSMode';

// ============================================
// KEEP ALL YOUR EXISTING IMPORTS AND DATA HERE
// ============================================
// [PASTE YOUR ENTIRE ORIGINAL App.jsx CONTENT BETWEEN THESE LINES]
// Include: STATCAST_PLAYERS, STATCAST_TENDENCIES, SUPABASE config,
// all helper functions, all components (PredictPage, GameDetailPage, 
// GMGame, TriviaPage, LeaderboardPage, FeedPage, HomePage, MembersPage, 
// Navbar, MessagesPage, ProfilePage, CardsPage, AnimeCardGame, MatchupPage, 
// NFFLPage, NBBLPage, RingRushPage, HubPage, StatsPage, NewsPage, DashboardPage, etc.)
// ============================================

// For brevity, I'm showing the structure. You need to paste your original code here.
// Your original App.jsx already has all these components. Keep them exactly as they are.

// ============================================
// MAIN APP COMPONENT (ONLY ONE)
// ============================================
...
export default function App(){
  ...
  const content=()=>{
    ...
    if(page==="gmmode")return <GMGame cu={cu}/>;  // GM Mode stays
    if(page==="rtts")return <RTTSMode cu={cu}/>;  // NEW: Road to the Show
